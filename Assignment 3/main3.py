...
# all the differnet data types I had are not working...
class FoodItem(SQLModel, table=True):
	fooditemUID: int = Field(default=None, primary_key=True)
	fooditemstatus: str  
	fooditemquantity: int 
	fooditemname: str
	fooditemfavorite: bool
	fooditemspecialtystore: str
	fooditemshoppinglist: str 			 
	fooditemexpirationreminder:  str
...
class ChoreItem(SQLModel, table=True):
	choreitemUID: int  = Field(default=None, primary_key=True)
	choreitemname: str
	choreitemduration: str
	choreitempriority: int
	choreitemlocation: str
	choreitemnotes:	str

class ChoreSchedule(SQLModel, table=True):
	scheduleUID: int  = Field(default=None, primary_key=True)
...
### FOODITEM
    @abstractmethod
    def do_create(self, fooditem: FoodItem):
        pass
# Read
    @abstractmethod
    def read_all(self):
...
# Read
    @abstractmethod
    def do_read(self, fooditemUID):
        pass
# Update
    @abstractmethod
    def do_update(self, fooditemUID: int, field: str, value):
        pass
# Delete
    @abstractmethod
    def do_delete(self, fooditemUID):
        pass

### CHOREITEM
    @abstractmethod
    def do_create(self, choreitem: ChoreItem):
        pass
# Read
    @abstractmethod
    def read_all(self):
...
# Read
    @abstractmethod
    def do_read(self, choreitemUID):
        pass
# Update
    @abstractmethod
    def do_update(self, choreitemUID: int, field: str, value):
        pass
# Delete
    @abstractmethod
    def do_delete(self, choreitemUID):
        pass

# CHORESCHEDULE
    @abstractmethod
    def do_create(self, schedule: ChoreSchedule):
        pass
# Read
    @abstractmethod
    def read_all(self):
...
# Read
    @abstractmethod
    def do_read(self, scheduleUID):
        pass
# Update
    @abstractmethod
    def do_update(self, scheduleUID: int, field: str, value):
        pass
# Delete
    @abstractmethod
    def do_delete(self, scheduleUID):
        pass		

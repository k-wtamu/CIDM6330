...
| Status   |  Gives information about the food or chore item  |  For food items: consumed, disposed of, or in current inventory. For chore items: scheduled, late, or completed.  |
...
statuses include 
stand alone events or repeat tasks
